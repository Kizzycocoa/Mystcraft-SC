...
public final class BookstandRenderPipelines {

    private BookstandRenderPipelines() {
    }
    ...
    private static RenderType getWorldRenderType(WoodType wood) {
        return WORLD_RENDER_TYPES.computeIfAbsent(wood, BookstandRenderPipelines::createWorldRenderType);
    }

    private static RenderType getGuiRenderType(WoodType wood) {
        return GUI_RENDER_TYPES.computeIfAbsent(wood, BookstandRenderPipelines::createGuiRenderType);
    }

    private static RenderType createWorldRenderType(WoodType wood) {
        String name = "bookstand_world_" + wood.getSerializedName();
    ...
    private static RenderType createGuiRenderType(WoodType wood) {
        String name = "bookstand_gui_" + wood.getSerializedName();
    ...
    private static Identifier getTexture(WoodType wood) {
        return Identifier.fromNamespaceAndPath(
                "mystcraft-sc",
                "textures/block/bookstand/" + wood.getSerializedName() + "bookstand.png"
        );
    }
}